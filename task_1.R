...
temp = robust_scaling(mod_data$Temp)
sal = robust_scaling(mod_data$Sal)
silicate = robust_scaling(mod_data$Silicate)
nitrate = robust_scaling(mod_data$Nitrite)
phosphate = robust_scaling(mod_data$Phosphate)

mod_data = cbind(mod_data, temp, sal, silicate, nitrate, phosphate)

# Select the name of the studied species
myRespName <- 'PA'

# Get corresponding presence/absence data
myResp <- mod_data[, myRespName]

# Get corresponding XY coordinates
myRespXY <- mod_data[, c('Longitude', 'Latitude')]
head(mod_data)
str(mod_data)
######## model ###############################
